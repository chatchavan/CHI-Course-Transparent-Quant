...
We will revisit Dataset 1 from last time, focusing on exploring how to
...
will demonstrate uncommenting code chunks to build up the plot. (Keyboard shortcut: Ctrl+Shift+C on Windows or Shift+Command+C on macOS) 
